"""
Django settings for rrsm project.
...
WSGI_APPLICATION = 'rrsm.wsgi.application'
...
# Outlier flagging ratios
RATIO_PGAX_PGAY_MIN=config('RATIO_PGAX_PGAY_MIN')
RATIO_PGAX_PGAY_MAX=config('RATIO_PGAX_PGAY_MAX')
RATIO_PGAX_PGAZ_MIN=config('RATIO_PGAX_PGAZ_MIN')
RATIO_PGAX_PGAZ_MAX=config('RATIO_PGAX_PGAZ_MAX')
RATIO_PGAY_PGAZ_MIN=config('RATIO_PGAY_PGAZ_MIN')
RATIO_PGAY_PGAZ_MAX=config('RATIO_PGAY_PGAZ_MAX')